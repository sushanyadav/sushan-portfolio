...
const Project = ({
  ...
  return (
    <div
      className={`${backgroundColorClass} p-14 pb-0 flex gap-20 rounded-3xl`}
    >
      ...
      <div className="overflow-hidden">
        <img
          src={image}
          alt={primaryText}
          style={{ maxHeight: "484px", minWidth: "664px" }}
          className="xl:w-full rounded-t-lg object-cover object-center"
        />
      </div>
    </div>
  );
