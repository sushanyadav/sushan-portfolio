...
const ScrollToTopButton = ({ showScrollToTopButton }) => {
  ...
  return (
    ...
    >
      <button
        id="scrollToTop"
        className="bg-gray-100 focus:outline-none opacity-70 shadow-md hover:bg-gray-200 focus:bg-gray-200 transition rounded-full  cursor-pointer h-8 w-8 flex items-center justify-center"
      >
        {/* <svg
